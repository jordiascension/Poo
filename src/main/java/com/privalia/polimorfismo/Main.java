...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (SeleccionFutbol integrante : integrantes) {
			System.out.print(concentracionSb.append(integrante.getNombre()).append(" ")
		...
		integrantes.forEach(integrante -> {
			System.out.print(concentracionForeachSb.append(integrante.getNombre()).append(" ")
					.append(integrante.getApellidos()).append(" -> "));
			integrante.concentrarse();
		});
		...
		for (SeleccionFutbol integrante : integrantes) {
			System.out.print(viajeSb.append(integrante.getNombre()).append(" ").append(integrante.getApellidos())
					.append(" -> "));
			integrante.viajar();
		}
		...
		for (SeleccionFutbol integrante : integrantes) {
			System.out.print(entrenamientoSb.append(integrante.getNombre()).append(" ")
					.append(integrante.getApellidos()).append(" -> "));
		...
		for (SeleccionFutbol integrante : integrantes) {
			System.out.print(partidoSb.append(integrante.getNombre()).append(" ").append(integrante.getApellidos())
					.append(" -> "));
		...
		System.out.print(
				planificarSb.append(delBosque.getNombre()).append(" ").append(delBosque.getApellidos()).append(" -> "));
		...
		System.out.print(
				entrevistaSb.append(iniesta.getNombre()).append(" ").append(iniesta.getApellidos()).append(" -> "));
		((Futbolista) iniesta).entrevista();

		// MASAJE
		StringBuilder masajeSb = new StringBuilder();
		System.out.println("\nMasaje: Solo el masajista tiene el método para dar un masaje:");
		System.out.print(masajeSb.append(raulMartinez.getNombre()).append(" ").append(raulMartinez.getApellidos())
				.append(" -> "));
